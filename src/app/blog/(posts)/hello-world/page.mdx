...
requires optimised SEO, etc. I work a lot with existing Next.js 12 projects so am relatively comfortable with it but
...
and not having to worry about having a million different stylesheets like before when I used SASS. Going to
Tailwind feels like an in-between where I can have my components and its styles viewable in one place but avoid the
bloatedness that comes with CSS-in-JS solutions. I can't say I really enjoy looking at the massive classNames that
seem to now be everywhere in the code but I am finding it quite quick for prototyping and just getting styles done.
