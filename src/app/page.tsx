...
const Home = () => {
    ...
    return (
        <section className="py-16 px-8" style={style}>
            <Image src="/portrait.webp" alt="Portrait of website author" width={180} height={180} className="mx-auto mb-7 border-2 rounded-[50%] shadow-[0_3px_10px_3px_rgba(100,100,100,1)]" />
        ...
        // <div>
        //     <Image src={background} placeholder="blur" className="backgroundImage" />
